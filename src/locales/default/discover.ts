export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>support@beice.com</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>support@beice.com</email>.',
  ...
  'createGuide.func1.title': 'Submit in Platform',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the the Community.',
  'footer.title': 'Share your creation on the Community today',
  ...
  'models.providerInfo.apiTooltip': 'Supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': '在北测数字 AI 中使用',
  ...
  'skills.details.sidebar.platform.layout.lobehub':
    'Skills are managed by the platform automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the marketplace with one click.',
