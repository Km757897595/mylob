export default {
  ...
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode.',
  ...
  'navPanel.newGroupTopic': 'New Topic',
  'navPanel.noUserGroup': 'No groups joined',
  'navPanel.searchAgent': 'Search Agent...',
  'navPanel.searchResultEmpty': 'No search results found',
  'navPanel.topicLocked': 'This topic is being used by another member',
  'navPanel.untitledTopic': 'Untitled',
  'navPanel.userGroup': 'User Groups',
  'new': 'New',
  'pro': 'Pro',
