export default {
  ...
  'protocolInstall.official.badge': 'Official Skill',
  'protocolInstall.official.description': 'Official Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. We do not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.title': 'Add skills to 北测数字 AI',
