export default {
  ...
  'memory.enabled.desc':
    'Allow the system to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'rbac.assignFailed': 'Failed to assign roles',
  'rbac.assignRole': 'Assign Role',
  'rbac.assignSuccess': 'Roles assigned successfully',
  'rbac.category': 'Category',
  'rbac.confirm': 'Confirm',
  'rbac.custom': 'Custom',
  'rbac.description': 'Description',
  'rbac.permCode': 'Permission Code',
  'rbac.permName': 'Permission Name',
  'rbac.permissions': 'Permissions',
  'rbac.roleCode': 'Role Code',
  'rbac.roleName': 'Role Name',
  'rbac.roles': 'Roles',
  'rbac.selectRoles': 'Select Roles',
  'rbac.system': 'System',
  'rbac.title': 'Role & Permission Management',
  'rbac.type': 'Type',
  'rbac.userIdPlaceholder': 'Enter User ID',
  'rbac.userSearchPlaceholder': 'Search by username or email',
  'userGroups.actions': 'Actions',
  'userGroups.addManager': 'Add Manager',
  'userGroups.addManagerFailed': 'Failed to add manager',
  'userGroups.addManagerSuccess': 'Manager added',
  'userGroups.addMember': 'Add Member',
  'userGroups.addMemberFailed': 'Failed to add member',
  'userGroups.addMemberSuccess': 'Member added',
  'userGroups.confirm': 'Confirm',
  'userGroups.createFailed': 'Failed to create group',
  'userGroups.createGroup': 'Create Group',
  'userGroups.createSuccess': 'Group created',
  'userGroups.deleteFailed': 'Failed to delete group',
  'userGroups.deleteSuccess': 'Group deleted',
  'userGroups.description': 'Description',
  'userGroups.descriptionPlaceholder': 'Enter description (optional)',
  'userGroups.groupName': 'Group Name',
  'userGroups.groupNamePlaceholder': 'Enter group name',
  'userGroups.groups': 'User Groups',
  'userGroups.manageMembers': 'Manage Members',
  'userGroups.managers': 'Managers',
  'userGroups.memberRole': 'Role',
  'userGroups.members': 'Members',
  'userGroups.noManagers': 'No managers yet',
  'userGroups.noMembers': 'No members yet',
  'userGroups.removeManager': 'Remove Manager',
  'userGroups.removeManagerFailed': 'Failed to remove manager',
  'userGroups.removeManagerSuccess': 'Manager removed',
  'userGroups.removeMember': 'Remove',
  'userGroups.removeMemberFailed': 'Failed to remove member',
  'userGroups.removeMemberSuccess': 'Member removed',
  'userGroups.roleAdmin': 'Admin',
  'userGroups.roleMember': 'Member',
  'userGroups.searchUserPlaceholder': 'Search by username or email',
  'userGroups.title': 'User Group Management',
  'userGroups.bindAgent': 'Bind Agent',
  'userGroups.bindAgentPlaceholder': 'Select an AI agent',
  'userGroups.bindAgentSuccess': 'Agent binding updated',
  'userGroups.bindAgentFailed': 'Failed to update agent binding',
  'userGroups.unbind': 'Unbind',
  'userGroups.boundAgent': 'Bound Agent',
  'tab.about': 'About',
