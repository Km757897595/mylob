export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using 北测数字 Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve the platform. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve the Platform',
  ...
  'screen5.actions.signInCloud': 'Sign in to 北测数字 Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your 北测数字 Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': '北测数字 Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own server instance',
